				...
				<div class="grid_12">
					<div class="menu_block">
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							...
							<li><a href="login.php">ADMIN</a></li>							</ul>
						</nav>
						<div class="clear"></div>
					</div>
				</div>
				...
				<div class="container_12">
					 <center><h3><font color="#9F9F9F">Search The Ticket<br><br></font></h3>
						...
						<form id="bookingForm" action="<? echo $_SERVER['PHP_SELF']; ?> " method="post">
								...
								<input  name="ticket" placeHolder="Ticket No:" type="text" data-constraints=''>&nbsp;&nbsp;&nbsp;
...
$l=$_POST['ticket'];
 ...
 $ctn="sher" . $l;
//deleting ticket no table


							$sql = "delete from ticketno where tno='{$ctn}'";
...
//cancel button
	...
	echo"<center>
	<BR><A href='cmssg.php' >
	<input type='submit' class='s1' value='Cancel' name='s' >
</a>	
		";
